  ...
  <div class="resume">
    ...
    <div class="rightCol">
      <div class="page-1">
        ...
        <div class="block" v-for="experience in person.page1" :key="experience.company">
          <div class="block-helper"></div>
          <h3 class="headline">{{experience.position}} - {{experience.company}}</h3>
          <div class="subheadline">{{experience.timeperiod}}</div>
          <p class="info">{{experience.description}}</p>
          <span class="tech">{{experience.technologies}}</span>
        </div>
      </div>
      <div class="page-2">
        <div class="block" v-for="experience in person.page2" :key="experience.company">
          <div class="block-helper"></div>
          <h3 class="headline">{{experience.position}} - {{experience.company}}</h3>
          <div class="subheadline">{{experience.timeperiod}}</div>
          <p class="info">{{experience.description}}</p>
...
#myselfpic {
  background-image: url('../../resume/ace.jpg');
  color: black;
  clip-path: ellipse(45% 45% at center);
}
#githubIcon {
  width: 25px;
  padding-left: 17px;
